...
#  TARGET_KERNEL_CONFIG := aokp_zara_defconfig
...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 16383
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1867775
BOARD_USERDATAIMAGE_PARTITION_SIZE := 4980736
BOARD_FLASH_BLOCK_SIZE := 00000200
...
TARGET_RECOVERY_FSTAB := device/htc/zara-common/rootdir/etc/fstab.zaracl
else
TARGET_RECOVERY_FSTAB := device/htc/zara-common/rootdir/etc/fstab.zaracl
endif
