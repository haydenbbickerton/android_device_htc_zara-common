...
#    $(LOCAL_PATH)/keylayout/h2w_headset.kl:system/usr/keylayout/h2w_headset.kl \
    $(LOCAL_PATH)/keylayout/device-keypad.kl:system/usr/keylayout/keypad_8960.kl \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/gps/gps.conf_default:system/etc/gps.conf_default \
    $(LOCAL_PATH)/gps/gps.conf_BOOST000:system/etc/gps.conf_BOOST000 \
    $(LOCAL_PATH)/gps/gps.conf_SPRINT00:system/etc/gps.conf_SPRINT00 \
    $(LOCAL_PATH)/gps/gps.conf_VM000000:system/etc/gps.conf_VM000000
...
$(call inherit-product, vendor/htc/zara-common/zara-common-vendor.mk)
